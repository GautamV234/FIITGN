  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return new Column(children:[ SizedBox(
              ...
              child:Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("What would you play today?",style: TextStyle(
                        fontSize: 37,
                        fontFamily: "Gro",
                      ),),
                    SizedBox(
        ...
        Center(child:Padding(padding: const EdgeInsets.symmetric(vertical:20),child:Container(height:130,child:ListView(
          ...
          children: snapshot.data.docs.map((DocumentSnapshot document) {
            return GestureDetector(
              ...
              child: Container(
                child:Column(children:[Container(width:MediaQuery.of(context).size.width/6,child:Image.asset('assets/ico.png',fit:BoxFit.contain)), SizedBox(
                      height: 10,
                    ),
                Text(
                    document['sportname'], 
